...
contract DeezModsDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    function _transfer(
        ...
        require(false, "DeezMods_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DeezMods_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main StackBNB contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "DeezMods_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );

        require(
            newClaimWait != claimWait,
            "DeezMods_Dividend_Tracker: Cannot update claimWait to same value"
        );
...
contract DeezMods is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;
    bool private inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    DeezModsDividendTracker public dividendTracker;
    ...
    constructor() ERC20("DeezMods", "DZM") {
        BNBRewardsFee = 1;
        liquidityFee = 1;
        extraFeeOnSell = 1; // extra fee on sell
        marketingFee = 4;
        marketingWallet = payable(0x36cDF6934D3a66a6621eE8751e0681D5f89D3cC6);
        totalFees = BNBRewardsFee.add(liquidityFee).add(marketingFee); // total fee transfer and buy
        dividendTracker = new DeezModsDividendTracker();
 ...
 */
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "StackBNB: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "StackBNB: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "StackBNB: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "StackBNB: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DeezMods: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DeezMods: Cannot update gasForProcessing to same value"
        );
